...
define('ASSES_SERVICES', PATH_SERVIS. '/Asses/AssesService.php');
define('CATEGORY_SERVICES', PATH_SERVIS. '/Category/CategoryService.php');
define('CATEGORYFATHER_SERVICES', PATH_SERVIS. '/CategoryFather/CategoryFatherService.php');
define('CITY_SERVICES', PATH_SERVIS. '/City/CityService.php');
define('COUNTRY_SERVICES', PATH_SERVIS. '/Country/CountryService.php');
define('LEVEL_SERVICES', PATH_SERVIS. '/Level/LevelService.php');
define('PRODUCT_SERVICES', PATH_SERVIS. '/Product/ProductService.php');
define('ROL_SERVICE', PATH_SERVIS. "/Rol/RolService.php");
