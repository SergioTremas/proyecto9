...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 01-12-2019 a les 21:21:48
...
INSERT INTO `assesment` (`idUser`, `idProduct`, `asses`, `opinion`, `assesfirst`) VALUES
(0, 4, 7, 'gfdgfd', 0),
(1, 1, 1, 'mal', 0),
(3, 1, 10, 'bien', 0),
(3, 4, 8, 'vhgdsgg fs', 0),
(15, 2, 4, 'ofejgojerogjedrtognd', 0),
(15, 5, 3, 'bien', 0);
...
(0, '', '12345', ''),
(1, '12345', 'tremosa@gmail.com', '14301d96f24a3f5cc9f995e1d5c95547b352a811e5193c1bea80d6bbdfb1985501122dd386291596fdbe258b2244943ab111f69892163ddcc7d52ef5f0e220f4'),
...
--
ALTER TABLE `city`
  MODIFY `idCity` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT per la taula `country`
--
ALTER TABLE `country`
  MODIFY `idCountry` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
